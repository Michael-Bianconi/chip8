...
_patterns = {
    ...
    '8xy0': lambda op: 'LD V' + op[1] + ', V' + op[2],
    '8xy1': lambda op: 'OR V' + op[1] + ', V' + op[2],
    '8xy2': lambda op: 'AND V' + op[1] + ', V' + op[2],
    '8xy3': lambda op: 'XOR V' + op[1] + ', V' + op[2],
    '8xy4': lambda op: 'ADD V' + op[1] + ', V' + op[2],
    '8xy5': lambda op: 'SUB V' + op[1] + ', V' + op[2],
    '8xy6': lambda op: 'SHR V' + op[1] + ', V' + op[2],
    '8xy7': lambda op: 'SUBN V' + op[1] + ', V' + op[2],
    '8xyE': lambda op: 'SHL V' + op[1] + ', V' + op[2],
    '9xy0': lambda op: 'SNE V' + op[1] + ', V' + op[2],
